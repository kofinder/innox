...
insert  into `custom_item_layout`(`id`,`custom_item_id`,`layout_name`,`layout_price`,`layout_image_path`,`status`,`created_by_id`,`created_time`,`updated_time`) values 
(10,1,'Layout 1',15000.00,'custom_layout/custom_layout_image/10/10_custom_layout_image_13704221998600IMG_3374.JPG',1,NULL,'2020-07-26 22:40:21','2020-07-26 22:40:21');
