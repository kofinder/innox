		...
		<div class="container-fluid">
			...
			<div class="card card-default">
				...
				<form:form role="form" id="banner_setup_form"
					modelAttribute="bannerDTO" action="banner_setup.html" method="POST"
								...
								<div class="form-group">
									...
									<div class="image show" style="margin-top: 20px;">
										<c:if test="${not empty bannerDTO.imagePath}">
											<img src="${bannerDTO.imagePath}" width="100px;" height="100px;"
												class="img-circle elevation-2" alt="Banner Image">
										</c:if>
									</div>
								</div>
							</div>
