...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Fonts</h1>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group" id="font_name_data">
									...
									<form:input path="name" id="font_name" placeholder="Font Name"
										class="form-control" />
								</div>
								<div class="form-group" id="font_url_data">
									<label for="fontURL">Font URL</label>
									<form:input path="fontURL" id="font_url" placeholder="Font URL"
										class="form-control" />
								</div>
			...
			<div class="card card-default">
				<div class="card-header">
					<h3 class="card-title">Font List</h3>
				...
				<div class="card-body">
					<div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
						<table id="example1"
							...
							<tbody>
								<c:forEach items="${fontList}" var="f" varStatus="count">
									<td><a href="font_setup.html?fontId=${f.seq}"> <i
											class="fas fa-edit"></i>
									</a></td>
									<td>${count.count}</td>
									<td>${f.name}</td>
