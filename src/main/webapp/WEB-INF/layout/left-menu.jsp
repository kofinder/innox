...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="resources/img/avatar2.png" class="img-circle elevation-2"
					alt="User Image">
			</div>
			<div class="info">
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item has-treeview"><a href="#" class="nav-link">
						...
						<p>
							Announcement <i class="right fas fa-angle-left"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="announcement_setup.html"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
				...
				<li class="nav-item has-treeview"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="color_setup.html"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Color Setup</p>
						</a></li>
						...
						<li class="nav-item"><a href="font_setup.html"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Font Setup</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item has-treeview"><a href="#" class="nav-link">
						...
						<p>
							Location Setup <i class="right fas fa-angle-left"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="state_setup.html"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>State Setup</p>
						</a></li>

						<li class="nav-item"><a href="zone_setup.html"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Zone Setup</p>
						</a></li>

						<li class="nav-item"><a href="township_setup.html"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Township Setup</p>
						</a></li>
					</ul></li>
